...
public class PlayerJoinInstruction implements ActionEffectInstruction {
    ...
    public @NotNull ResourceLocation getId() {
        return ResourceLocation.fromNamespaceAndPath(CobblemonRaidDens.MOD_ID, "player_join");
    }
