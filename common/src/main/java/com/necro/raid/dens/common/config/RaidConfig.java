...
public class RaidConfig implements ConfigData {
    ...
    @Comment("How much currency is rewarded for clearing a raid boss (Requires CobbleDollars). Default: [1000, 2000, 5000, 10000, 20000, 50000, 100000]")
    public int[] tier_currency = {1000, 2000, 5000, 10000, 20000, 50000, 100000};
