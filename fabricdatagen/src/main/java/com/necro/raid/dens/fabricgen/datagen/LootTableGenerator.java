        ...
        consumer.accept(
            ...
            new LootTable.Builder()
                .pool(LootPool.lootPool().setRolls(UniformGenerator.between(2f, 4f))
                    .with(TagEntry.expandTag(CobblemonItemTags.APRICORNS)
            ...
            new LootTable.Builder()
                .pool(LootPool.lootPool().setRolls(UniformGenerator.between(3f, 6f))
                    ...
                    .with(LootItem.lootTableItem(Items.COPPER_INGOT)
                        ...
                        .setWeight(2)
                        .build())
                    .with(TagEntry.expandTag(CobblemonItemTags.APRICORN_SPROUTS)
            ...
            new LootTable.Builder()
                .pool(LootPool.lootPool().setRolls(UniformGenerator.between(3f, 6f))
                    ...
                    .with(LootItem.lootTableItem(CobblemonItems.EXPERIENCE_CANDY_M)
                        ...
                        .setWeight(5)
                        .build())
                    .with(TagEntry.expandTag(CobblemonItemTags.FEATHERS)
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(1f, 2f)))
                        .setWeight(5)
                        .build())
                    .with(TagEntry.expandTag(CobblemonItemTags.MOCHIS)
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(1f, 2f)))
                        .setWeight(5)
                        .build())
                    .with(TagEntry.expandTag(CobblemonItemTags.MINT_LEAF)
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(1f, 2f)))
                        .setWeight(2)
                        .build())
                    .with(LootItem.lootTableItem(Items.AIR)
                        ...
                        .setWeight(5)
                        .build())
                    .with(TagEntry.expandTag(ItemTags.CHEERS)
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1f)))
                        .setWeight(2)
                        .build())
                    .build()
            ...
            new LootTable.Builder()
                .pool(LootPool.lootPool().setRolls(UniformGenerator.between(4f, 6f))
                    ...
                    .with(TagEntry.expandTag(CobblemonItemTags.MINT_LEAF)
                        ...
                        .setWeight(5)
                        .build())
                    .with(TagEntry.expandTag(CobblemonItemTags.MINT_SEEDS)
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1f)))
                        .setWeight(2)
                        .build())
