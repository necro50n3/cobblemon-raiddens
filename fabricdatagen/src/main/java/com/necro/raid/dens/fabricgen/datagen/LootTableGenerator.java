    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> consumer) {
        consumer.accept(
            ...
            new LootTable.Builder()
                ...
                .pool(LootPool.lootPool().setRolls(ConstantValue.exactly(1f))
                    .when(RaidPouchCondition.matches(RaidFeature.Base.TERA.getId()))
                ...
                .pool(LootPool.lootPool().setRolls(ConstantValue.exactly(1f))
                    .when(RaidPouchCondition.matches(RaidFeature.Base.DYNAMAX.getId()))
                    .with(LootItem.lootTableItem(Items.AIR)
                ...
                .pool(LootPool.lootPool().setRolls(ConstantValue.exactly(1f))
                    .when(RaidPouchCondition.matches(RaidFeature.Base.SHADOW.getId()))
                    .with(LootItem.lootTableItem(Items.AIR)
                        .apply(ShadowShardsFunction.apply())
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(3f, 5f)))
                        .build())
                    .build()
                )
                .pool(LootPool.lootPool().setRolls(ConstantValue.exactly(1f))
                    .when(BonusLootCondition.matches(true))
                    .with(LootItem.lootTableItem(Items.AIR)
                        .apply(GemTypeFunction.apply())
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(1f, 2f)))
                        .setWeight(9)
                        .build())
                    .with(LootItem.lootTableItem(ModItems.CATCHING_CHARM.value())
                        .apply(SetComponentsFunction.setComponent(ModComponents.CATCH_BOOST.value(), 0.1F))
                        .build())
                    .build()
                )
        );
        ...
        consumer.accept(
            ...
            new LootTable.Builder()
                ...
                .pool(LootPool.lootPool().setRolls(ConstantValue.exactly(1f))
                    ...
                    .with(LootItem.lootTableItem(Items.AIR)
                        .apply(ShadowShardsFunction.apply())
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(7f, 9f)))
                        .build())
                    .build()
                )
                .pool(LootPool.lootPool().setRolls(UniformGenerator.between(1f, 2f))
                    .when(BonusLootCondition.matches(true))
                    .with(LootItem.lootTableItem(Items.AIR)
                        .apply(GemTypeFunction.apply())
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(1f, 2f)))
            ...
            new LootTable.Builder()
                .pool(LootPool.lootPool().setRolls(UniformGenerator.between(3f, 6f))
                    ...
                    .with(LootItem.lootTableItem(CobblemonItems.SWIFT_FEATHER)
                        ...
                        .setWeight(5)
                        .build())
                    .with(LootItem.lootTableItem(CobblemonItems.HEALTH_MOCHI)
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(1f, 2f)))
                        .setWeight(5)
                        .build())
                    .with(LootItem.lootTableItem(CobblemonItems.MUSCLE_MOCHI)
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(1f, 2f)))
                        .setWeight(5)
                        .build())
                    .with(LootItem.lootTableItem(CobblemonItems.RESIST_MOCHI)
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(1f, 2f)))
                        .setWeight(5)
                        .build())
                    .with(LootItem.lootTableItem(CobblemonItems.CLEVER_MOCHI)
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(1f, 2f)))
                        .setWeight(5)
                        .build())
                    .with(LootItem.lootTableItem(CobblemonItems.GENIUS_MOCHI)
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(1f, 2f)))
                        .setWeight(5)
                        .build())
                    .with(LootItem.lootTableItem(CobblemonItems.SWIFT_MOCHI)
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(1f, 2f)))
                        .setWeight(5)
                        .build())
                ...
                .pool(LootPool.lootPool().setRolls(ConstantValue.exactly(1f))
                    ...
                    .with(LootItem.lootTableItem(Items.AIR)
                        .apply(ShadowShardsFunction.apply())
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(11f, 13f)))
                        .setWeight(4)
                        .build())
                    .with(LootItem.lootTableItem(Items.AIR)
                        .apply(ScentsFunction.apply())
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1f)))
                        .build())
                    .build()
                )
                .pool(LootPool.lootPool().setRolls(UniformGenerator.between(1f, 2f))
                    ...
                    .with(LootItem.lootTableItem(Items.AIR)
                        ...
                        .build())
                    .with(LootItem.lootTableItem(ModItems.CATCHING_CHARM.value())
                        .apply(SetComponentsFunction.setComponent(ModComponents.CATCH_BOOST.value(), 0.2F))
                        .build())
                    .with(LootItem.lootTableItem(ModItems.CATCHING_CHARM.value())
                        .apply(SetComponentsFunction.setComponent(ModComponents.CATCH_BOOST.value(), 0.1F))
                        .build())
            ...
            new LootTable.Builder()
                .pool(LootPool.lootPool().setRolls(UniformGenerator.between(4f, 6f))
                    ...
                    .with(LootItem.lootTableItem(ModItems.HEAL_CHEER.value())
                        ...
                        .setWeight(5)
                        .build())
                    .with(LootItem.lootTableItem(CobblemonItems.HEALTH_CANDY)
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1f)))
                        .setWeight(2)
                        .build())
                    .with(LootItem.lootTableItem(CobblemonItems.MIGHTY_CANDY)
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1f)))
                        .setWeight(2)
                        .build())
                    .with(LootItem.lootTableItem(CobblemonItems.TOUGH_CANDY)
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1f)))
                        .setWeight(2)
                        .build())
                    .with(LootItem.lootTableItem(CobblemonItems.SMART_CANDY)
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1f)))
                        .setWeight(2)
                        .build())
                    .with(LootItem.lootTableItem(CobblemonItems.COURAGE_CANDY)
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1f)))
                        .setWeight(2)
                        .build())
                    .with(LootItem.lootTableItem(CobblemonItems.QUICK_CANDY)
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1f)))
                        .setWeight(2)
                        .build())
                    .with(LootItem.lootTableItem(CobblemonItems.SICKLY_CANDY)
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1f)))
                        .build())
                    .with(LootItem.lootTableItem(CobblemonItems.WEAK_CANDY)
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1f)))
                        .build())
                    .with(LootItem.lootTableItem(CobblemonItems.BRITTLE_CANDY)
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1f)))
                        .build())
                    .with(LootItem.lootTableItem(CobblemonItems.NUMB_CANDY)
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1f)))
                        .build())
                    .with(LootItem.lootTableItem(CobblemonItems.COWARD_CANDY)
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1f)))
                        .build())
                    .with(LootItem.lootTableItem(CobblemonItems.SLOW_CANDY)
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1f)))
                        .build())
                    .with(LootItem.lootTableItem(Items.AIR)
                        .apply(TMTypeFunction.apply())
                ...
                .pool(LootPool.lootPool().setRolls(ConstantValue.exactly(1f))
                    ...
                    .with(LootItem.lootTableItem(Items.AIR)
                        .apply(ShadowShardsFunction.apply())
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(15f, 17f)))
                        .setWeight(4)
                        .build())
                    .with(LootItem.lootTableItem(Items.AIR)
                        .apply(ScentsFunction.apply())
                ...
                .pool(LootPool.lootPool().setRolls(UniformGenerator.between(1f, 2f))
                    ...
                    .with(LootItem.lootTableItem(Items.AIR)
                        ...
                        .build())
                    .with(LootItem.lootTableItem(ModItems.CATCHING_CHARM.value())
                        .apply(SetComponentsFunction.setComponent(ModComponents.CATCH_BOOST.value(), 0.3F))
                        .build())
                    .with(LootItem.lootTableItem(ModItems.CATCHING_CHARM.value())
                        .apply(SetComponentsFunction.setComponent(ModComponents.CATCH_BOOST.value(), 0.2F))
                        .build())
        ...
        consumer.accept(
            ...
            new LootTable.Builder()
                ...
                .pool(LootPool.lootPool().setRolls(ConstantValue.exactly(1f))
                    ...
                    .with(LootItem.lootTableItem(Items.AIR)
                        .apply(ShadowShardsFunction.apply())
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(19f, 21f)))
                        .setWeight(3)
                        .build())
                    .with(LootItem.lootTableItem(Items.AIR)
                        .apply(ScentsFunction.apply())
                ...
                .pool(LootPool.lootPool().setRolls(UniformGenerator.between(1f, 3f))
                    .when(BonusLootCondition.matches(true))
                    .with(LootItem.lootTableItem(Items.AIR)
                        .apply(GemTypeFunction.apply())
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(2f, 3f)))
                    ...
                    .with(LootItem.lootTableItem(Items.AIR)
                        ...
                        .build())
                    .with(LootItem.lootTableItem(ModItems.CATCHING_CHARM.value())
                        .apply(SetComponentsFunction.setComponent(ModComponents.CATCH_BOOST.value(), 0.5F))
                        .build())
                    .with(LootItem.lootTableItem(ModItems.CATCHING_CHARM.value())
                        .apply(SetComponentsFunction.setComponent(ModComponents.CATCH_BOOST.value(), 0.3F))
                        .build())
        ...
        consumer.accept(
            ...
            new LootTable.Builder()
                ...
                .pool(LootPool.lootPool().setRolls(UniformGenerator.between(2f, 3f))
                    .with(LootItem.lootTableItem(Items.AIR)
                        .apply(TMTypeFunction.apply())
                        .build())
                    .build()
                ...
                .pool(LootPool.lootPool().setRolls(ConstantValue.exactly(1f))
                    ...
                    .with(LootItem.lootTableItem(Items.AIR)
                        .apply(ShadowShardsFunction.apply())
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(24f, 26f)))
                        .setWeight(3)
                        .build())
                    .with(LootItem.lootTableItem(Items.AIR)
                        .apply(ScentsFunction.apply())
                ...
                .pool(LootPool.lootPool().setRolls(UniformGenerator.between(1f, 3f))
                    ...
                    .with(LootItem.lootTableItem(Items.AIR)
                        ...
                        .build())
                    .with(LootItem.lootTableItem(ModItems.CATCHING_CHARM.value())
                        .apply(SetComponentsFunction.setComponent(ModComponents.CATCH_BOOST.value(), 0.75F))
                        .build())
                    .with(LootItem.lootTableItem(ModItems.CATCHING_CHARM.value())
                        .apply(SetComponentsFunction.setComponent(ModComponents.CATCH_BOOST.value(), 0.5F))
                        .build())
        ...
        consumer.accept(
            ...
            new LootTable.Builder()
                ...
                .pool(LootPool.lootPool().setRolls(ConstantValue.exactly(3f))
                    .with(LootItem.lootTableItem(Items.AIR)
                        .apply(TMTypeFunction.apply())
                        .build())
                    .build()
                ...
                .pool(LootPool.lootPool().setRolls(ConstantValue.exactly(1f))
                    ...
                    .with(LootItem.lootTableItem(Items.AIR)
                        .apply(ShadowShardsFunction.apply())
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(28f, 32f)))
                        .setWeight(3)
                        .build())
                    .with(LootItem.lootTableItem(Items.AIR)
                        .apply(ScentsFunction.apply())
                ...
                .pool(LootPool.lootPool().setRolls(UniformGenerator.between(2f, 3f))
                    ...
                    .with(LootItem.lootTableItem(Items.AIR)
                        ...
                        .build())
                    .with(LootItem.lootTableItem(ModItems.CATCHING_CHARM.value())
                        .apply(SetComponentsFunction.setComponent(ModComponents.CATCH_BOOST.value(), 1F))
                        .build())
                    .with(LootItem.lootTableItem(ModItems.CATCHING_CHARM.value())
                        .apply(SetComponentsFunction.setComponent(ModComponents.CATCH_BOOST.value(), 0.75F))
                        .build())
